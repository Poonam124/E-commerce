        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-8">
              ...
              <button className="w-12 h-12 bg-white border-2 border-gray-300 rounded-full flex items-center justify-center hover:border-green-400 hover:text-green-400 transition-colors">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {relatedProducts.map((item) => (
                ...
                >
                  ...
                  <h3 className="text-sm font-medium text-gray-800 mb-1 group-hover:text-green-600 transition-colors">
                    {item.name}
                  </h3>
