      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="mt-6 max-w-3xl w-full mx-auto">
            <div className="relative group">
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-green-200 via-rose-200 to-amber-200 opacity-0 group-focus-within:opacity-100 blur-sm transition-opacity duration-300 pointer-events-none" />
            ...
            <div className="mt-3 flex flex-wrap gap-2 text-xs sm:text-sm text-gray-500">
              ...
              {["Bags", "Mug", "Keychain", "Art"].map((tag) => (
                <button
                  ...
                  className="px-2.5 py-1 rounded-full bg-white/80 hover:bg-green-50 border border-green-100 text-gray-600 hover:text-gray-800 transition-colors"
                >
                  {tag}
                </button>
              ))}
        ...
        <div className="flex gap-8">
          ...
          <div className="hidden lg:block w-64 flex-shrink-0">
            <div className="bg-green-100 rounded-lg p-6 shadow-sm sticky top-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {sortedProducts.map((product) => {
                ...
                return (
                  ...
                  >
                    <div className="bg-green-100 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                      <div className="aspect-square overflow-hidden">
                        {img ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center text-2xl text-amber-900 bg-green-50">
                            {product.name?.[0] || "P"}
                          </div>
                        )}
                      </div>
