...
const Home = () => {
  ...
  return (
    <div className="w-full bg-green-100 overflow-x-hidden">
      {/* Hero Section */}
      <div className="w-full flex items-center justify-center">
        <div className="w-full min-h-[30vh] sm:min-h-[30vh] md:h-[25vw] text-center bg-gradient-to-r from-[#d4ebdf] via-white to-[#d4ebdf] py-12 sm:py-16 md:py-20 px-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
              {bestSellersToShow.map((product) => {
                ...
                return (
                  ...
                  >
                    <div className="bg-green-200 rounded-lg sm:rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                      <div className="aspect-square overflow-hidden">
                        {img ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center text-2xl sm:text-3xl text-amber-900 bg-green-100">
                            {product.name?.[0] || "P"}
                          </div>
                        )}
                      </div>
      ...
      {/* Features Section */}
      <div className="w-full py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 bg-green-200">
