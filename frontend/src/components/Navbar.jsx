...
const handleCartClick = async () => {
  ...
  return (
    <div className="w-screen m-0 p-0">
      ...
      <div className="hidden md:flex w-full bg-green-200 py-2 px-4 lg:px-20 justify-between items-center border-b m-0">
      ...
      {/* PROMO BAR */}
      <div className="w-full bg-green-100 py-2 md:py-3 border-b overflow-hidden">
      ...
      {/* MAIN NAVBAR */}
      <div className="w-full flex items-center justify-between py-4 md:py-5 px-4 sm:px-8 bg-green-200 border-b m-0 relative z-30">
      ...
      >
        <div className="flex flex-col text-gray-700 h-full">
          ...
          <div
            ...
            className="flex items-center gap-4 p-4 cursor-pointer border-b bg-green-50"
          >
            <X className="h-5 w-5" />
          ...
          <Link
            to="/contact"
            onClick={() => setVisible(false)}
            className="py-4 pl-6 border-b hover:bg-green-50 transition-colors"
          >
            Contact
          </Link>
          <Link
          ...
          <div className="mt-4 border-t pt-4">
            <Link
              to="/collection"
              onClick={() => setVisible(false)}
              className="py-3 pl-6 block hover:bg-green-50 transition-colors text-sm text-gray-600"
            >
              All Products
            </Link>
            <Link
          ...
          <div className="mt-auto p-6 border-t bg-green-50">
