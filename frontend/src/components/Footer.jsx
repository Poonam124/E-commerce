...
const Footer = () => {
  ...
  return (
    <footer className="bg-green-100 text-[#1c1b1b] pt-16 pb-8 font-sans">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          ...
          <div className="w-full md:w-1/2 lg:w-1/3">
            <h3 className="font-serif text-xl font-bold mb-4">Be NEXTKART's Insider</h3>
        ...
        <div className="border-t border-gray-300/50 pt-10">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-x-6 gap-y-2 text-[10px] uppercase tracking-wider text-gray-700 text-center">
            <span>&copy; 2025, NEXTKART Powered by Shopify</span>
