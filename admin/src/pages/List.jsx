              ...
              >
                ...
                >
                  {mainImage ? (
                    ...
                    <div className="bg-gradient-to-br from-green-100 via-purple-100 to-blue-100 h-full w-full flex items-center justify-center text-3xl font-bold text-amber-900">
                      {product.name?.[0] || "P"}
                    </div>
                  )}
                </div>
