  ...
  return (
    <div className="w-full bg-green-50">
      <div className="w-full px-4 sm:px-8 py-8">
        ...
        {/* 🔍 Search & Filter */}
        <div className="bg-green-100 rounded-lg shadow-sm p-6 mb-8">
        ...
        {sortedOrders.length === 0 ? (
          <div className="bg-green-100 rounded-lg shadow-sm p-12 text-center">
            ...
            <Link
              to="/collection"
              className="inline-block bg-gray-700 text-green-100 px-8 py-3 rounded-full font-medium hover:bg-gray-800 transition-colors no-underline"
            >
              Start Shopping
            </Link>
          </div>
          ...
          <div className="space-y-6">
            {sortedOrders.map((order) => {
              ...
              return (
                <div
                  key={order._id}
                  className="bg-green-100 rounded-lg shadow-sm overflow-hidden"
                >
                  {/* Header */}
